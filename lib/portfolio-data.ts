...
export const flagship = {
  ...
  blurb:
    'My flagship: an agentic operator platform that lets one person direct a coordinated swarm across offensive, defensive, and purple-team work. A 41-unit fleet, channel-bound identity, a single kill-switch. Built solo.',
  metric: '41 units',
  status: 'Private RC',
};
...
export const proofPoints = [
  ...
  { label: 'Platform scale', value: '41 units', note: 'generated from the real repos · single-binary each' },
];
