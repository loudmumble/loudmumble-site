...
{`    ██╗     ███╗   ███╗
    ...
    ╚══════╝╚═╝     ╚═╝`}
      ...
      <div className="space-y-1">
        <div><span className="text-terminal-cyan">loudmumble</span>@<span className="text-terminal-magenta">kitty</span></div>
        ...
        <div><span className="text-terminal-cyan">Terminal:</span> kitty</div>
...
export const WhoamiOutput = () => {
  return (
    <div className="font-mono text-sm">
      <div className="text-terminal-green">loudmumble</div>
      <div className="text-muted-foreground text-xs mt-1">
        uid=1337(loudmumble) gid=1337(security) groups=1337(security),27(sudo),1000(pentest)
      </div>
    </div>
  );
};
