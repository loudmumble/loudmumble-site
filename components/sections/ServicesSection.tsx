...
const services: Service[] = [
  {
    ...
    description: 'Full-scope security assessments following OWASP/PTES methodology. Web apps, APIs, internal networks, cloud infrastructure. Deliverables include executive summary, technical findings with PoC, and prioritized remediation guidance.',
    tag: 'METHODOLOGIES',
  ...
  },
  {
    ...
    description: 'Zero-day hunting in self-hosted and open-source software. Manual code review, fuzzing, auth bypass analysis. Responsible disclosure with Nuclei template development for regression testing.',
    tag: 'TARGETS',
